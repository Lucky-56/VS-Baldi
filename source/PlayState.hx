	...
	override public function create()
	{
		...
		switch(stageCheck)
		{
			...
			case 'school':
			{
					...
					var bgSchool:FlxSprite = new FlxSprite(repositionShit, 0).loadGraphic(Paths.image('weeb/weebSchool','week2'));
					bgSchool.scrollFactor.set(0.6, 0.90);
					add(bgSchool);

					var bgStreet:FlxSprite = new FlxSprite(repositionShit).loadGraphic(Paths.image('weeb/weebStreet','week2'));
			...
			case 'schoolEvil':
			{
					...
					bg.frames = Paths.getSparrowAtlas('weeb/animatedEvilSchool','week2');
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " - " + CoolUtil.difficultyFromInt(storyDifficulty) + " | KE " + MainMenuState.kadeEngineVer, 16);
